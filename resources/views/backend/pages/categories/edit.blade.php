...
<form action="{{ route('admin.category.update', $category_edit->id) }}" method="post" enctype="multipart/form-data">
  @csrf
  <div class="form">
    <div class="form-group">
      <label for="name">Title</label>
      <input type="name" class="form-control col-md-6" id="name" name="name" value="{{$category_edit->name}}"
