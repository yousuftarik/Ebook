...
@section('content')
<!-- partial -->
<h4 style="text-align: center">Create category order</h4>
<form action="{{ route('admin.cat_order.create') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="type">Category</label>
            <select id="type" class="form-control" name="category_id">
                {{-- <option value="{{$old_category->id}}" selected>{{$old_category->name}}</option> --}}
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control col-md-6" id="serial" name="serial" placeholder="serial">
        </div>
    </div>


    <input type="submit" class="btn btn-primary" value="Create category order">
</form>
